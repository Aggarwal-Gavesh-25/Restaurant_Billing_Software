...
void generateBillHeader(char name[50],char date[30])                                                        //functions to generate biils
{                                                                                   
...
int main()
{
    ...
    {                                                                                                           //While loop starts
        ...
        printf("\t============ADV. RESTAURANT============");                                                    // Printing the header of the bill and taking the input of the user
